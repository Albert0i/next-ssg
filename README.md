...
Throughout this example, [Pages Router](https://nextjs.org/docs/pages) is used instead of [App Router](https://nextjs.org/docs/app). Typically, **SSG and ISR are Page Router features NOT App Router features**. 
