...
### V. Summary
There no a rule of thumb for everythng. There is no right or wrong, only a difference of types of applications. Obviously, SSG doesn't work with [OLTP](https://www.oracle.com/database/what-is-oltp/). A 10 pages or 10,000 pages website MUST be tackled differently... 
