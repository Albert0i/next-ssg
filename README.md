...
Throughout this example, [Pages Router](https://nextjs.org/docs/pages) is used instead of [App Router](https://nextjs.org/docs/app). After all, **SSG and ISR are Page Router features NOT App Router features**. 
...
Trying to knock the walls, only muffled noise resounds. Definitely behind the walls are some kind of heavy materials. Not having mallet and chisel on hand, besides working on a confined box is awkward... is impossible... 
